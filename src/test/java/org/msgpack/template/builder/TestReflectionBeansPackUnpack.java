...
public class TestReflectionBeansPackUnpack extends TestSet {
    ...
    public void testPrimitiveTypeFieldsClass(PrimitiveTypeFieldsClass v)
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<PrimitiveTypeFieldsClass> tmpl = builder
                .buildTemplate(PrimitiveTypeFieldsClass.class);
    ...
    public void testPrimitiveTypeFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<PrimitiveTypeFieldsClassNotNullable> tmpl = builder
                .buildTemplate(PrimitiveTypeFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testReferenceTypeFieldsClass(ReferenceTypeFieldsClass v)
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ReferenceTypeFieldsClass> tmpl = builder
                .buildTemplate(ReferenceTypeFieldsClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testReferenceTypeFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ReferenceTypeFieldsClassNotNullable> tmpl = builder
                .buildTemplate(ReferenceTypeFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testListTypeFieldsClass(ListTypeFieldsClass v) throws Exception {
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ListTypeFieldsClass> tmpl = builder
                .buildTemplate(ListTypeFieldsClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testListTypeFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ListTypeFieldsClassNotNullable> tmpl = builder
                .buildTemplate(ListTypeFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testMapTypeFieldsClass(MapTypeFieldsClass v) throws Exception {
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<MapTypeFieldsClass> tmpl = builder
                .buildTemplate(MapTypeFieldsClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testMapTypeFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<MapTypeFieldsClassNotNullable> tmpl = builder
                .buildTemplate(MapTypeFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testModifiersFieldsClass(ModifiersFieldsClass v)
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ModifiersFieldsClass> tmpl = builder
                .buildTemplate(ModifiersFieldsClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testModifiersFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ModifiersFieldsClassNotNullable> tmpl = builder
                .buildTemplate(ModifiersFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testUserDefinedTypeFieldsClass(UserDefinedTypeFieldsClass v)
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<UserDefinedTypeFieldsClass> tmpl = builder
                .buildTemplate(UserDefinedTypeFieldsClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testUserDefinedTypeFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<UserDefinedTypeFieldsClassNotNullable> tmpl = builder
                .buildTemplate(UserDefinedTypeFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testReferenceCycleTypeFieldsClass(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ReferenceCycleTypeFieldsClass> tmpl = builder
                .buildTemplate(ReferenceCycleTypeFieldsClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testReferenceCycleTypeFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<ReferenceCycleTypeFieldsClassNotNullable> tmpl = builder
                .buildTemplate(ReferenceCycleTypeFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
        Unpacker unpacker = msgpack.createUnpacker(new ByteArrayInputStream(
                bytes));
        unpacker.resetReadByteCount();
        ReferenceCycleTypeFieldsClassNotNullable ret = tmpl
                .read(unpacker, null);
        assertEquals(v, ret);
        assertEquals(bytes.length, unpacker.getReadByteCount());
    }
    ...
    public void testInheritanceClass(InheritanceClass v) throws Exception {
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<InheritanceClass> tmpl = builder
                .buildTemplate(InheritanceClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testInheritanceClassNotNullable(InheritanceClassNotNullable v)
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<InheritanceClassNotNullable> tmpl = builder
                .buildTemplate(InheritanceClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testMessagePackableTypeFieldsClass(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<MessagePackableTypeFieldsClass> tmpl = builder
                .buildTemplate(MessagePackableTypeFieldsClass.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
    ...
    public void testMessagePackableTypeFieldsClassNotNullable(
        ...
        ReflectionBeansTemplateBuilder builder = new ReflectionBeansTemplateBuilder(
                registry);
        Template<MessagePackableTypeFieldsClassNotNullable> tmpl = builder
                .buildTemplate(MessagePackableTypeFieldsClassNotNullable.class);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        Packer packer = msgpack.createPacker(out);
        tmpl.write(packer, v);
        byte[] bytes = out.toByteArray();
