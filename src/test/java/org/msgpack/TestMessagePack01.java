...
public class TestMessagePack01 {
    ...
    public static class TestBigIntegerBufferPackBufferUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
    ...
    public static class TestBigIntegerBufferPackConvert extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testBigInteger() throws Exception {
    ...
    public static class TestBigIntegerBufferPackUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testBigInteger() throws Exception {
    ...
    public static class TestBigIntegerPackBufferUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testBigInteger() throws Exception {
    ...
    public static class TestBigIntegerUnconvertConvert extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testBigInteger() throws Exception {
    ...
    public static class TestStringBufferPackBufferUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
    ...
    public static class TestByteArrayBufferPackBufferUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
    ...
    public static class TestByteArrayBufferPackConvert extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testByteArray() throws Exception {
    ...
    public static class TestByteArrayBufferPackUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testByteArray() throws Exception {
    ...
    public static class TestByteArrayPackBufferUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testByteArray() throws Exception {
    ...
    public static class TestByteArrayUnconvertConvert extends
            org.msgpack.TestSet {
        @Test
        @Override
        public void testByteArray() throws Exception {
    ...
    public static class TestListBufferPackBufferUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
        ...
        @Override
        public <E> void testList(List<E> v, Class<E> elementClass)
                throws Exception {
            MessagePack msgpack = new MessagePack();
    ...
    public static class TestMapBufferPackBufferUnpack extends
            org.msgpack.TestSet {
        @Test
        @Override
        ...
        public <K, V> void testMap(Map<K, V> v, Class<K> keyElementClass,
            ...
            Map<K, V> ret = msgpack.read(bytes, new HashMap<K, V>(),
                    tMap(tKey, tValue));
            if (v == null) {
                assertEquals(null, ret);
                return;
    ...
    public void testValuePassedAsObject() throws IOException {
        ...
        Object value = ValueFactory
                .createRawValue("This class is Value but...");
